...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form id="login" action="student_login" method="POST">
    {{csrf_field()}}
      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="matric_num" placeholder="Matric number">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-5">
          <button type="submit" name="stud_signin" class="btn btn-primary btn-raised btn-block btn-flat">Sign In</button>
        </div>
        <span >
        <!-- /.col -->
      </div><br>
    ...
    <form id="registration" action="student_registration" method="POST">
    {{csrf_field()}}
    <div class="form-group has-feedback">
      ...
      <div class="form-group">
        <label for="sel1"></label>
        <select class="form-control" id="sel1" name="yes" required>
          <option >Select Institution</option>
          <option value="FUTA" >Federal university of science and technology </option>
          <option value="AAUA">Adekunle Ajasin Akungba University</option>
          <option value="OSUSTECH">Ondo State University Of Science and Technology</option>
        </select>
      </div>

      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="matric_num" placeholder="Matric number" required>
